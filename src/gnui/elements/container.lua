...
---Acts as a rectangle to hold UI together.
---@class GNUI.container : GNUI.element
---@field Dimensions Vector4 # `X`,`Y` Determins the offset of the top left,`Z`,`W` for the bottom right
---@field MinimumSize Vector2 # Test Comment
---@field GrowDirection Vector2 # Test Comment
---@field ContainerShift Vector2 # Test Comment
---@field Z number # Test Comment
---@field ContainmentRect Vector4 # Test Comment
---@field DIMENSIONS_CHANGED EventLib # Test Comment
---@field SIZE_CHANGED EventLib # Test Comment
---@field Margin Vector4 # Test Comment
---@field MARGIN_CHANGED EventLib # Test Comment
---@field Padding Vector4 # Test Comment
---@field PADDING_CHANGED EventLib # Test Comment
---@field Anchor Vector4 # Test Comment
---@field ANCHOR_CHANGED EventLib # Test Comment
---@field Sprite Sprite # Test Comment
---@field SPRITE_CHANGED EventLib # Test Comment
---@field Cursor Vector2? # Test Comment
---@field CURSOR_CHANGED EventLib # Test Comment
---@field Hovering boolean # Test Comment
---@field CaptureCursor boolean # Test Comment
---@field PRESSED EventLib # Test Comment
---@field MOUSE_ENTERED EventLib # Test Comment
---@field MOUSE_EXITED EventLib # Test Comment
---@field ClipOnParent boolean # Test Comment
---@field isClipping boolean # Test Comment
---@field isVisible boolean # Test Comment
---@field Part ModelPart # Test Comment
local container = {}
